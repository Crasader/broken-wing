...
PT_MODEL_DECL(PTModelLinker);
PT_MODEL_DECL(PTModelComponentHealth);
...
public:
    ...
    PTModelComponentHealthPtr charactersHealthComponent() const; //Assuming all characters have the same health component
    ...
    void removeAssociatedMotors(std::vector<PTPObject*> objects);
